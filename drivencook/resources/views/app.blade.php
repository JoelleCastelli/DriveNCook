                    ...
                    @if (auth()->user())
                        <li class="nav-item dropdown ml-4">
                            ...
                            <div class="dropdown-menu dropdown-menu-right bg-dark" aria-labelledby="userDropdownMenuButton">
                                <a class="dropdown-item text-light" href="{{ route('client_dashboard') }}">{{ trans('auth.my_account') }}</a>
                    ...
                    @else
                        <li class="nav-item dropdown ml-4">
                            ...
                            <div class="dropdown-menu dropdown-menu-right bg-dark" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item text-light d-flex align-items-baseline" href="#" data-toggle="modal" data-target="#formModal_client">
                                    <i class="fa fa-user"></i>&nbsp;&nbsp;{{ trans('homepage.login_client') }}
                                </a>
                                <a class="dropdown-item text-light d-flex align-items-baseline" href="#" data-toggle="modal" data-target="#formModal_franchisee">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div role="tabpanel">
                            ...
                            <ul class="nav nav-tabs mb-1" role="tablist">
                                <li class="active nav-item">
                                    <a href="#franchisee_login" class="nav-link active" aria-controls="uploadTab" role="tab" data-toggle="tab">{{ trans('franchisee.login') }}</a>
                                </li>
                                <li class="nav-item">
                                    <a href="#franchisee_first_connexion" class="nav-link" aria-controls="browseTab" role="tab" data-toggle="tab">{{ trans('franchisee.first_login') }}</a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="franchisee_login">
                                    <form name="franchisee_login_form" method="post" action="{{ route('franchise.login_submit') }}">
                                        {{ csrf_field() }}
                                        <div class="form-group">
                                ...
                                <div role="tabpanel" class="tab-pane" id="franchisee_first_connexion">
                                    @if (!isset($pseudos))
                                        <form name="franchisee_first_login_form" action="{{ route('franchise.complete_registration_email') }}" method="post">
                                            {{ csrf_field() }}
                                            <div class="form-group">
                                    ...
                                    @elseif(isset($pseudos))
                                        <form action="{{ route('franchise.complete_registration_submit') }}" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                @if(empty($pseudos))
                                                    <div class="form-control" style="color: red" type="text">{{ trans('franchisee.no_pseudo_available') }}</div>
                                                @else
                                                    <div class="input-group">
                                                        <select class="custom-select" name="pseudo" id="pseudo" required>
                                                            <option disabled selected value>{{ trans("franchisee.enter_pseudo") }}</option>
