                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                        <div class="card text-light2">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item bg-indigo">{{ trans('franchisee.obligations_revenue_percentage') }}
                                    <b>{{ $current_obligation['revenue_percentage'] }} %</b></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-6 col-lg-4">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="franchisee_invoices_list"
                            ...
                            @foreach($invoices as $invoice)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="ml-2"
                                           href="{{ route('franchise.stream_franchisee_invoice_pdf',['id'=>$invoice['id']]) }}"
                                           target="_blank">
...
@section('script')
    <script type="text/javascript">
        $(document).ready(function () {
            let table = $('#franchisee_invoices_list').DataTable({searchPanes: true});
