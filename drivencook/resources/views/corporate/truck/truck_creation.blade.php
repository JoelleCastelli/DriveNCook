                ...
                <div class="card-body">
                    <form method="post" action="{{ route('truck_creation_submit') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="registration_document" id="registration_document" value="{{ old('registration_document') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="general_state" id="general_state" value="{{ old('general_state') }}"
