        ...
        <form method="post" action="{{ route('truck_creation_submit') }}">
            <div class="form-group">
                ...
                <input type="text" name="brand" id="brand"
                       placeholder="{{ trans('truck_creation.set_brand') }}" class="form-control" maxlength="30">
            </div>

            <div class="form-group">
                <label for="model">{{ trans('truck_creation.model') }}</label>
                <input type="text" name="model" id="model"
                       placeholder="{{ trans('truck_creation.set_model') }}" class="form-control" maxlength="30">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="license_plate" id="license_plate"
                       placeholder="{{ trans('truck_creation.set_license_plate') }}" class="form-control" minlength="9" maxlength="9">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="registration_document" id="registration_document"
                       placeholder="{{ trans('truck_creation.set_registration_document') }}" class="form-control" minlength="15" maxlength="15">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="insurance_number" id="insurance_number"
                       placeholder="{{ trans('truck_creation.set_insurance_number') }}" class="form-control" minlength="20" maxlength="20">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="chassis_number" id="chassis_number"
                       placeholder="{{ trans('truck_creation.set_chassis_number') }}" class="form-control" minlength="20" maxlength="20">
            </div>

            <div class="form-group">
                <label for="engine_number">{{ trans('truck_creation.engine_number') }}</label>
                <input type="text" name="engine_number" id="engine_number"
                       placeholder="{{ trans('truck_creation.set_engine_number') }}" class="form-control" minlength="20" maxlength="20">
            </div>

            <div class="form-group">
                <label for="horsepower">{{ trans('truck_creation.horsepower') }}</label>
                <input type="number" name="horsepower" id="horsepower"
                       placeholder="{{ trans('truck_creation.set_horsepower') }}" class="form-control" min="1">
            </div>

            <div class="form-group">
                <label for="weight_empty">{{ trans('truck_creation.weight_empty') }}</label>
                <input type="number" name="weight_empty" id="weight_empty"
                       placeholder="{{ trans('truck_creation.set_weight_empty') }}" class="form-control" min="1">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="general_state" id="general_state"
                       placeholder="{{ trans('truck_creation.set_general_state') }}" class="form-control" maxlength="255">
            </div>
