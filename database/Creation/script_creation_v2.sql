...
create table drivencook.location
(
    id         int auto_increment
        primary key,
    name       varchar(30)  null,
...
create table drivencook.pseudo
(
    id         int auto_increment
        primary key,
...
(
    ...
    constraint user_pseudo_id_fk
        foreign key (pseudo_id) references drivencook.pseudo (id)
);

create table drivencook.event
(
    id          int auto_increment
        primary key,
    ...
    constraint event_location_id_fk
        foreign key (location_id) references drivencook.location (id),
    constraint event_user_id_fk
        foreign key (user_id) references drivencook.user (id)
);

create table drivencook.event_invited
(
    event_id int not null,
    user_id  int not null,
    primary key (event_id, user_id),
    constraint event_invited_event_id_fk
        foreign key (event_id) references drivencook.event (id),
    constraint event_invited_user_id_fk
        foreign key (user_id) references drivencook.user (id)
);

create table drivencook.fidelity_step
(
    id        int auto_increment
        primary key,
    step      int not null,
...
create table drivencook.franchise_obligation
(
    id                   int auto_increment
        primary key,
...
create table drivencook.franchisee_stock
(
    user_id    int                  not null,
    ...
    constraint stock_dish_id_fk
        foreign key (dish_id) references drivencook.dish (id),
    constraint stock_user_id_fk
        foreign key (user_id) references drivencook.user (id)
);

create table drivencook.sale
(
    id               int auto_increment
        primary key,
    ...
    constraint sale_user_id_fk
        foreign key (user_franchised) references drivencook.user (id),
    constraint sale_user_id_fk_2
        foreign key (user_client) references drivencook.user (id)
);

create table drivencook.sold_dish
(
    dish_id    int       not null,
    ...
    constraint sold_dish_sale_id_fk
        foreign key (sale_id) references drivencook.sale (id)
);

create table drivencook.truck
(
    id                    int auto_increment
        primary key,
...
create table drivencook.breakdown
(
    id          int auto_increment
        primary key,
    ...
    constraint breakdown_truck_id_fk
        foreign key (truck_id) references drivencook.truck (id)
);

create table drivencook.safety_inspection
(
    id             int auto_increment
        primary key,
    date           date         null,
...
create table drivencook.warehouse
(
    id          int auto_increment
        primary key,
    name        varchar(30) null,
...
create table drivencook.purchase_order
(
    id           int auto_increment
        primary key,
    user_id      int                                                                   null,
    ...
    constraint purchase_order_warehouse_id_fk
        foreign key (warehouse_id) references drivencook.warehouse (id)
);

create table drivencook.invoice
(
    id                int auto_increment
        primary key,
    amount            float                                                 null,
    ...
    constraint invoice_purchase_order_id_fk
        foreign key (purchase_order_id) references drivencook.purchase_order (id),
...
create table drivencook.purchased_dish
(
...
create table drivencook.warehouse_stock
(
    warehouse_id    int       not null,
    dish_id         int       not null,
    quantity        int       null,
